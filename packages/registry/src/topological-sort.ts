/**
 * Stolen from: @pnpm/deps.graph-sequencer
 * Source code: https://github.com/pnpm/pnpm/blob/main/deps/graph-sequencer/src/index.ts
 * Date: 2025-09-27
 */
 ...
 */
export function topologicalSort<T>(graph: Graph<T>, includedNodes: T[] = [...graph.keys()]): Result<T> {
