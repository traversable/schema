...
const GeneratorByTag = {
  ...
  optional: (x, _$, isProperty) => isProperty ? x[1] : fc.oneof(x[1], fc.constant(undefined)),
  non_optional: (x) => x[1].map((_) => _ === undefined ? {} : _),
  undefinedable: (x) => fc.oneof(x[1], fc.constant(undefined)),
  nullable: (x) => fc.oneof(x[1], fc.constant(null)),
