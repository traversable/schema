...
function toJsonSchemaRef<S, Id extends string>(this: t.ref<S, Id>) { return JsonSchema.ref(this.id) }
...
function toJsonSchemaObject<S extends { [x: string]: t.Schema }>(this: t.object<S>): ReturnType<typeof JsonSchema.object> { return JsonSchema.object(this.def) }
