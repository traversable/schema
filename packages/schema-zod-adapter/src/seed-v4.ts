...
import type { ZodArray, ZodRecord, ZodObject, ZodTuple } from './utils-v4.js'
import { PromiseSchemaIsUnsupported } from './utils-v4.js'
...
export const byTag = {
  ...
  template_literal: 600 as const,
  array: 1000 as const,
  nonoptional: 1500 as const,
  nullable: 2000 as const,
  optional: 2500 as const,
  readonly: 3000 as const,
  set: 3500 as const,
  ...
  union: 8500 as const,
  pipe: 9000 as const,
  custom: 9500 as const,
  transform: 10_000 as const,
  lazy: 10_500 as const,
  //  deprecated
  /** @deprecated */
