 ...
 * ## {@link deepEqual_classic `zx.deepEqual.classic`}
 *
 * Derive an in-memory _deepEqual function_ from a zod schema (v4, classic).
 *
 * An "deepEqual function" (see also, {@link Equal `Equal`}) is similar to
 ...
 * ## {@link deepEqual_writeable `zx.deepEqual.writeable`}
 *
 * Derive a "writeable" (stringified) _deepEqual function_ 
