...
function get<S extends Schema>(schema: S, ...path: (keyof any)[]) {
...
function get$<S extends Schema, K1 extends keyof S['def'], V = S['def'][K1]>(schema: S, ...path: [K1]): V
function get$<S extends Schema>(schema: S, ...path: []): S
/// impl.
function get$<S extends Schema>(schema: S, ...path: (keyof any)[]) {
