...
vi.describe('〖⛳️〗‹‹‹ ❲@traverable/schema❳: t.Recursive.toString', () => {
  vi.it('〖⛳️〗‹ ❲t.Recursive.toString(t.void)❳', () => vi.expect(t.recurse.toString(t.void)).toMatchInlineSnapshot(`"t.void"`))
  vi.it('〖⛳️〗‹ ❲t.Recursive.toString(t.any)❳', () => vi.expect(t.recurse.toString(t.any)).toMatchInlineSnapshot(`"t.any"`))
  vi.it('〖⛳️〗‹ ❲t.Recursive.toString(t.unknown)❳', () => vi.expect(t.recurse.toString(t.unknown)).toMatchInlineSnapshot(`"t.unknown"`))
  vi.it('〖⛳️〗‹ ❲t.Recursive.toString(t.null)❳', () => vi.expect(t.recurse.toString(t.null)).toMatchInlineSnapshot(`"t.null"`))
  vi.it('〖⛳️〗‹ ❲t.Recursive.toString(t.undefined)❳', () => vi.expect(t.recurse.toString(t.undefined)).toMatchInlineSnapshot(`"t.undefined"`))
  vi.it('〖⛳️〗‹ ❲t.Recursive.toString(t.symbol)❳', () => vi.expect(t.recurse.toString(t.symbol)).toMatchInlineSnapshot(`"t.symbol"`))
  vi.it('〖⛳️〗‹ ❲t.Recursive.toString(t.boolean)❳', () => vi.expect(t.recurse.toString(t.boolean)).toMatchInlineSnapshot(`"t.boolean"`))
  vi.it('〖⛳️〗‹ ❲t.Recursive.toString(t.bigint)❳', () => vi.expect(t.recurse.toString(t.bigint)).toMatchInlineSnapshot(`"t.bigint"`))
  vi.it('〖⛳️〗‹ ❲t.Recursive.toString(t.number)❳', () => vi.expect(t.recurse.toString(t.number)).toMatchInlineSnapshot(`"t.number"`))
  vi.it('〖⛳️〗‹ ❲t.Recursive.toString(t.string)❳', () => vi.expect(t.recurse.toString(t.string)).toMatchInlineSnapshot(`"t.string"`))
