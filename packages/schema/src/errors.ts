...
} as const satisfies Record<string, (got: unknown, ctx: Functor.Index, expected?: unknown) => ValidationError>

interface Unary {
  invalid(got: unknown, ctx: Functor.Index, expected?: unknown): ValidationError
  excess(got: unknown, ctx: Functor.Index, expected?: unknown): ValidationError
  missing(got: unknown, ctx: Functor.Index, expected?: unknown): ValidationError
}
...
} satisfies Record<string, (ctx: Functor.Index, got: unknown, expected?: unknown) => ValidationError>
