...
flowchart TD
    ...
    schema-parser(@traversable/schema-parser) -.-> json(@traversable/json)
    schema-parser(@traversable/schema-parser) -.-> registry(@traversable/registry)
    schema-parser(@traversable/schema-parser) -.-> schema-core(@traversable/schema-core)
